...
type HealthInfo struct {
	...
	LastHeartBeat int64 `protobuf:"varint,2,opt,name=LastHeartBeat,proto3" json:"LastHeartBeat,omitempty"`
}
...
func (x *HealthInfo) GetTTL() int64 {
	if x != nil {
		return x.TTL
	}
	return 0
...
func (x *HealthInfo) GetLastHeartBeat() int64 {
	if x != nil {
...
type GetHealthInfoReply struct {
	...
	HealthInfos []*HealthInfo `protobuf:"bytes,1,rep,name=HealthInfos,proto3" json:"HealthInfos,omitempty"`
}
...
func (x *GetHealthInfoReply) GetHealthInfos() []*HealthInfo {
	if x != nil {
...
var file_miniRouter_proto_rawDesc = []byte{
	...
	,
...
var file_miniRouter_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_miniRouter_proto_goTypes = []interface{}{
	...
	(*HealthInfo)(nil),           // 10: HealthInfo
	(*GetHealthInfoRequest)(nil), // 11: GetHealthInfoRequest
	(*GetHealthInfoReply)(nil),   // 12: GetHealthInfoReply
}
var file_miniRouter_proto_depIdxs = []int32{
	...
	10, // 2: GetHealthInfoReply.HealthInfos:type_name -> HealthInfo
	2,  // 3: RegisterService.Register:input_type -> RegisterRequest
	4,  // 4: RegisterService.Deregister:input_type -> DeregisterRequest
	6,  // 5: DiscoveryService.GetInstances:input_type -> GetInstancesRequest
	8,  // 6: HealthService.HeartBeat:input_type -> HeartBeatRequest
	11, // 7: HealthService.GetHealthInfo:input_type -> GetHealthInfoRequest
	3,  // 8: RegisterService.Register:output_type -> RegisterReply
	5,  // 9: RegisterService.Deregister:output_type -> DeregisterReply
	7,  // 10: DiscoveryService.GetInstances:output_type -> GetInstancesReply
	9,  // 11: HealthService.HeartBeat:output_type -> HeartBeatReply
	12, // 12: HealthService.GetHealthInfo:output_type -> GetHealthInfoReply
