...
func (c *echoServiceClient) Echo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
...
func (UnimplementedEchoServiceServer) Echo(context.Context, *Request) (*Reply, error) {
